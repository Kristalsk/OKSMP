 ...
 begin
  ...
  begin
   ...
   begin
    ...
    xlogForm.chbSaveLog.Checked := true;
   end else  xlogForm.chbSaveLog.Checked := false;
...
if tLoginForm(Sender).ModalResult <> mrOK then
  ...
  if xlogForm.chbSaveLog.Checked = true  then
     begin
     xIniFile.WriteInteger('SaveLogin', 'loginFlag', 1);
     xIniFile.WriteString('SaveLogin', 'login', xLogForm.Edit1.text );
     xIniFile.WriteString('SaveLogin', 'password', xLogForm.Edit2.text);
     end   else
     begin
      xIniFile.WriteInteger('SaveLogin', 'loginFlag', 0);
      xIniFile.WriteString('SaveLogin', 'login', '' );
      xIniFile.WriteString('SaveLogin', 'password', '');
      end;
